    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certification', models.IntegerField(choices=[('PLC', 'PLC'), ('Advanced Certificate', 'Adv Certificate'), ('Bachelors', 'Bachelors'), ('Bachelors Hons', 'Bachelors Honours'), ('Masters', 'Masters'), ('Doctorate', 'Doctorate')])),
