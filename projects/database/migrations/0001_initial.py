    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certification', models.CharField(choices=[('PLC', 'PLC'), ('Advanced Certificate', 'Adv Certificate'), ('Bachelors', 'Bachelors'), ('Bachelors Hons', 'Bachelors Honours'), ('Masters', 'Masters'), ('Doctorate', 'Doctorate')], max_length=45)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('training', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.trainingapplication')),
